...
Route::get('/user/pay/{id}', [RegistrationUserController::class, 'payPendingUser'])->name('user.pay');
...
Route::get('/user/create_member', [UserController::class, 'createMember'])->name('user.create_member'); 
...
Route::get('/payment/paystack/verify', [RegistrationUserController::class, 'verifyPaystackPayment'])
    ->name('payment.paystack.verify');
...
Route::get('registeruser/step/{step}', function ($step) {
        return view("superadmin.registeruser.step{$step}", ['step' => $step]);
...
Route::post('/check-user', [SuperAdminDashboardController::class, 'checkUser']);
...
Route::get('/superadmin/registeruser/step/{step}', [RegistrationAdminController::class, 'showAdminStep'])->name('superadmin.registeruser.step');
Route::post('/superadmin/registeruser/step/{step}', [RegistrationAdminController::class, 'postAdminStep'])->name('superadmin.registeruser.post');
