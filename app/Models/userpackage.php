...
class userpackage extends Model
{
    protected $table = 'userpackage'; 
        protected $fillable = [
        'transaction_id','total_amount_package','previous_package_id','previous_package_cpt','previous_bottle','acctName','bankName','amount','user_id', 'package_id', 'amount_paid', 'ctp_received', 'payment_method', 'status', 'payment_proof','approved_at', 'approved_by', 'is_approved','package_order_status'
    ];
...
//{
  //  return $this->hasMany(Bonus::class, 'source_user_id', 'user_id');
//}
...
public function bonusesTriggered()
{
    return $this->hasMany(Bonus::class, 'transaction_id', 'transaction_id')
