...
<li class="nav-item dropdown notification_dropdown">
    ...
    ₦{{ number_format($item['price'], 2) }} + ₦{{ number_format($item['apc'] ?? 0, 2) }} x {{ $item['quantity'] }}
        ...
        @if($cartCount > 0)
            ...
            <a class="all-notification d-block text-center" href="{{ route('superadmin.admincheckout') }}">
...
<li class="nav-item dropdown notification_dropdown">
    ...
    {{ isset($pendingBonusCount) ? $pendingBonusCount : 0 }}
</span>

    </a>
    <div class="dropdown-menu dropdown-menu-end">
        <div id="DZ_W_Notification1" class="widget-media dlab-scroll p-3" style="height:380px;">
            <h6 style="margin-bottom: 20px;"> Pending Registration Bonuses</h6>
          <ul class="timeline">
                    ...
                    <li>
                        <div class="timeline-panel">
                            <div class="media-body">
                                <h6 class="mb-1">
                                    {{ $bonus->user->first_name }}  {{ $bonus->user->last_name }} (₦{{ number_format($bonus->amount, 2) }})
                                </h6>
                                <small class="d-block">
                ...
                @empty
                    <li><div class="timeline-panel">No pending bonuses</div></li>
                @endforelse
            </ul>
        </div>
        <a class="all-notification" href="{{ route('superadmin.bonuses.regBonus') }}">
            See all Bonuses <i class="ti-arrow-end"></i>
        </a>
    </div>
</li>
          ...
          <li class="nav-item dropdown notification_dropdown">
            <a class="nav-link " href="javascript:void(0);" data-bs-toggle="dropdown">
              ...
              <span class="badge light text-white bg-red rounded-circle">0</span>
            </a>
