...
<div class="table-responsive">
       <table class="table table-responsive-md">
             ...
             <a href="{{ asset($data->payment_proof) }}" target="_blank">View Proof</a>
                            @else
                                No Proof
                            @endif
                        </td>
   ...
   <form action="{{ route('superadmin.transaction.approveTopup', $data->id) }}" method="POST" onsubmit="return confirm('Approve this payment?');">
                                @csrf
