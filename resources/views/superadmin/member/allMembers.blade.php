...
@endif
                    ...
                    <td>
                        ...
                        @else
                            <span class="badge bg-success">Unmuted</span>
                        @endif
                    </td>
...
<div class="dropdown">
  ...
  <ul class="dropdown-menu" aria-labelledby="sortDropdown">
   <li><a class="dropdown-item" href="{{ route('superadmin.member.edituserprofile', $user->id) }}">Edit Profile</a></li>
<li>
    <a class="dropdown-item" href="{{ route('superadmin.member.editSponsor', $user->id) }}">
        Change Sponsor & Downline
    </a>
</li>
