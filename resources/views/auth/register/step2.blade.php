...
<div id="upline_group"> 
    ...
    <input type="text" name="sponsor_username"
        id="sponsor_username"
        value="{{ old('sponsor_username', $data['sponsor_username'] ?? '') }}"
        class="form-control"  >

    <small id="upline_info" class="text-success" style=" padding:5px; border:solid 1px #F0F0F0; line-height:60px; font-size:17px; font-weight:600;"></small>
    <span id="sponsor_error" class="text-danger " style=" padding:5px; border:solid 1px #F0F0F0; line-height:60px; font-size:17px; font-weight:600;"></span>
</div>
