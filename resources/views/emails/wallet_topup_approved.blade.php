    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="max-width: 600px; margin: auto; background-color: #ffffff; font-family: 'Poppins', Arial, sans-serif;">
      ...
      <tr>
        <td style="padding: 20px; text-align: center;">
          <h2 style="margin: 0; font-size: 22px; color: #333;">Wallet Top-up Approved</h2>
        </td>
      </tr>
...
<p>Your wallet top-up of <strong>₦{{ number_format($topup->amount, 2) }}</strong> has been approved and your wallet has been credited.</p>
