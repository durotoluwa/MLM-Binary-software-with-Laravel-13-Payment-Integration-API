    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="max-width: 600px; margin: auto; background-color: #ffffff; font-family: 'Poppins', Arial, sans-serif;">
      ...
      <tr>
        <td style="padding: 20px; text-align: center;">
          <h2 style="margin: 0; font-size: 22px; color: #333;">User Withdrawal Details</h2>
        </td>
      </tr>
...
<p>Hello Admin,</p>
<p>User <strong>{{ $user->username }}</strong> has withdraw o <strong>₦{{ number_format($withdrawal->amount, 2) }}</strong>.</p>
