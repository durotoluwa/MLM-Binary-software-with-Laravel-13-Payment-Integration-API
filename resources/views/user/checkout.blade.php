...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const orderForSelect = document.getElementById('order_for');
    const memberUsernameInput = document.querySelector('[name="member_username"]');
    ...
    function payWithPaystack() {
        ...
        const handler = PaystackPop.setup({
            ...
            callback: function (response) {
                ...
                const orderFor = orderForSelect.value;
                ...
                // Only send username if buying for member
                if (orderFor === 'member') {

                    const username = memberUsernameInput.value.trim();

                    if (!username) {
                        alert('Please enter member username.');
                        return;
                    }

                    payload.member_username = username;
                }
