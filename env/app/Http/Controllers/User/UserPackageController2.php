...
public function handleMatchingBonus(User $user, $ctpGained, $generation = 1)
{
    ...
    // Matching bonus logic (evaluate once per ancestor)
    ...
    // Recurse upward to next ancestor, but don’t re‑apply CPT to the same upline again
