                  ...
                  <div class="col-xl-8 col-xxl-7 col-sm-7">
                    <div class="update-profile d-flex">
                      ...
                      <div class="ms-4">
                        ...
                        <span>
                          <i class="fas fa-map-marker-alt me-1"></i>Medan, Sumatera Utara - ID </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="items">
                    <div class="jobs">
                      ...
                      <div class="bottom-info pt-1">
                        <p class="mb-0">
                          <i class="fas fa-map-marker-alt me-2"></i>Manchester, England
                        </p>
                        <p class="mb-0">
                          <i class="fas fa-comments-dollar me-2"></i>$ 2,000 - $ 2,500
                        </p>
                      </div>
                    </div>
                  </div>
