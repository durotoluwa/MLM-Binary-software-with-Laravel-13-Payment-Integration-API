    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="max-width: 600px; margin: auto; background-color: #ffffff; font-family: 'Poppins', Arial, sans-serif;">
      ...
      <tr>
        <td style="padding: 20px; text-align: center;">
          <h2 style="margin: 0; font-size: 22px; color: #333;">Hello {{ $data['upline']->first_name }}</h2>
        </td>
      </tr>
...
<p>Congratulations! You just earned a <strong>registration bonus</strong> of <strong>₦{{ number_format($data['amount']) }}</strong>.</p>

<p>This is from your {{ $data['level'] }} level downline: <strong>{{ $data['downline']->username }}</strong></p>

<p>Keep growing your network with DLT Health plus.</p>
        </td>
      </tr>
