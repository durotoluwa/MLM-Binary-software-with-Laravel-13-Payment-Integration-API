    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="max-width: 600px; margin: auto; background-color: #ffffff; font-family: 'Poppins', Arial, sans-serif;">
      ...
      <tr>
        <td style="padding: 20px; text-align: center;">
          <h2 style="margin: 0; font-size: 22px; color: #333;">Welcome {{ $data['first_name'] }}, TO DLT Health Plus</h2>
        </td>
      </tr>
...
<p>Thank you for registering with DLT Health Plus.</p>
  <p>Your registration was successful. You can now login and complete your registration payment.</p>

<p>Your username: <strong>{{ $data['user']->username }}</strong></p>
<p>We'll notify you when your registration payment is confirmed.</p>
        </td>
      </tr>
