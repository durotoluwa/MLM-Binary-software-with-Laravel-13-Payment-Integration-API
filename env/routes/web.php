...
Route::get('/superadmin/registermember/step/{step}', [RegistrationAdminController::class, 'showAdminStep'])
    ->name('superadmin.registermember.step');

// POST route for submitting steps
Route::post('/superadmin/registermember/step/{step}', [RegistrationAdminController::class, 'postAdminStep'])
    ->name('superadmin.registermember.post');
